...
with DAG("emr_python_abstraction_compact_ui", default_args=default_args, schedule_interval=timedelta(1), tags=['workshop']) as dag:
    with EmrClusterCompactUI(dag) as emr:
        emr.add_spark_steps("spark_transform", SparkUtils.spark_app(S3_ARTIFACTS, "com.as24.meshteam.SparkApp"))
